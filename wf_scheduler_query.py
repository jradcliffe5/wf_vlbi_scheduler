...
ra_center = Angle(vexfile.source[first_source_name]['ra']).degree
dec_center = Angle(vexfile.source[first_source_name]['dec']).degree ### need to convert 
...
r = r[keep_cols]
print(r)
r.write('RACS_potential_phase_centers.csv',overwrite=True)
RA_column = keep_cols[0]
Dec_column = keep_cols[1]
flux_column = keep_cols[2]
catalogue='RACS_potential_phase_centers.csv'
